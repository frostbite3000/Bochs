...
#ifndef BX_COREI3_IVY_BRIDGE_3220_CPUID_DEFINITIONS_H
#define BX_COREI3_IVY_BRIDGE_3220_CPUID_DEFINITIONS_H

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

#include "cpu/cpuid.h"

class corei3_ivy_bridge_3220_t : public bx_cpuid_t {
public:
  corei3_ivy_bridge_3220_t(BX_CPU_C *cpu);
  virtual ~corei3_ivy_bridge_3220_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "corei3_ivy_bridge_3220"; }
...
extern bx_cpuid_t *create_corei3_ivy_bridge_3220_cpuid(BX_CPU_C *cpu);
