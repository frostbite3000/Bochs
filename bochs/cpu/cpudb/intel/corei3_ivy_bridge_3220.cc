...
#include "corei3_ivy_bridge_3220.h"

#define LOG_THIS cpu->

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

corei3_ivy_bridge_3220_t::corei3_ivy_bridge_3220_t(BX_CPU_C *cpu): bx_cpuid_t(cpu)
{
  if (BX_SUPPORT_VMX == 1)
    BX_INFO(("You must compile with --enable-vmx=2 for Intel Core i3 Ivy Bridge VMX configuration"));
...
void corei3_ivy_bridge_3220_t::get_cpuid_leaf(Bit32u function, Bit32u subfunction, cpuid_function_t *leaf) const
{
  // Intel(R) Core(TM) i3-3220 CPU @ 3.30GHz
  // CPUID 80000002: 20202020-20202020-65746E49-2952286C [        Intel(R)]
  // CPUID 80000003: 726F4320-4D542865-33692029-3232332D [ Core(TM) i3-322]
  // CPUID 80000004: 50432030-20402055-30332E33-007A4847 [0 CPU @ 3.30GHz]
  static const char* brand_string = "       Intel(R) Core(TM) i3-3220 CPU @ 3.30GHz";
...
Bit32u corei3_ivy_bridge_3220_t::get_vmx_extensions_bitmask(void) const
{
...
// leaf 0x00000001 //
void corei3_ivy_bridge_3220_t::get_std_cpuid_leaf_1(cpuid_function_t *leaf) const
{
  // CPUID 00000001: 000306A9-00100800-3D9AE3BF-BFEBFBFF
...
// leaf 0x00000002 //
void corei3_ivy_bridge_3220_t::get_std_cpuid_leaf_2(cpuid_function_t *leaf) const
{
...
// leaf 0x00000004 //
void corei3_ivy_bridge_3220_t::get_std_cpuid_leaf_4(Bit32u subfunction, cpuid_function_t *leaf) const
{
  // CPUID function 0x00000004 - Deterministic Cache Parameters
  // i3-3220 has 2 cores, 4 threads (2 threads per core)
  // L1D: 32 KB, 8-way, 64-byte line
  // L1I: 32 KB, 8-way, 64-byte line
  // L2:  256 KB, 8-way, 64-byte line
  // L3:  3 MB, 12-way, 64-byte line (shared)
  ...
  case 1:
    ...
    break;
  case 2:
    // CPUID 00000004: 1C004143-01C0003F-000001FF-00000000 [SL 02] [L2U: 256 KB]
    leaf->eax = 0x1C004143;
    leaf->ebx = 0x01C0003F;
    leaf->ecx = 0x000001FF;
    leaf->edx = 0x00000000;
    break;
  case 3:
    // CPUID 00000004: 1C03C163-02C0003F-00000FFF-00000006 [SL 03] [L3U: 3 MB]
    leaf->eax = 0x1C03C163;
    leaf->ebx = 0x02C0003F;
    leaf->ecx = 0x00000FFF;
    leaf->edx = 0x00000006;
...
// leaf 0x00000007 //
void corei3_ivy_bridge_3220_t::get_std_cpuid_leaf_7(Bit32u subfunction, cpuid_function_t *leaf) const
{
...
// leaf 0x0000000A //
void corei3_ivy_bridge_3220_t::get_std_cpuid_leaf_A(cpuid_function_t *leaf) const
{
...
// leaf 0x80000001 //
void corei3_ivy_bridge_3220_t::get_ext_cpuid_leaf_1(cpuid_function_t *leaf) const
{
...
void corei3_ivy_bridge_3220_t::dump_cpuid(void) const
{
  bx_cpuid_t::dump_cpuid(max_std_leaf, max_ext_leaf);
}

bx_cpuid_t *create_corei3_ivy_bridge_3220_cpuid(BX_CPU_C *cpu) { return new corei3_ivy_bridge_3220_t(cpu); }
